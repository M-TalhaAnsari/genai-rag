...
class Recipe(BaseModel):
    ...
    ingredients: List[str] = Field(..., description="List of the required ingredients for the recipe")
    instructions: str = Field(..., description="Step by step cooking instruction")
    calorie_estimate: int = Field(..., description="Estime calories per serving")
...
class VitaminInfo(BaseModel):
    ...
    percentage_div: str = Field(..., description="Percentage of the daily value")

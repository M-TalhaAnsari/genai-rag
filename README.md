...
Image captioning system (vision-to-text)
AI meeting assistant (speech summarization & action extraction)
...
FAISS / ChromaDB
OpenAI API/ Groq API / Gemini API
LangSmith
HTML / CSS /Gradio (for UI-based apps)
Flask
Prompt Engineering
...
Implementation of RAG pipelines for structured and unstructured data
Integration of local and cloud-based LLMs
...
Focused on RAG systems, multimodal AI, and LLM-based applications

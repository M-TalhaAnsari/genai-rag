...
class MCPPermissionHostApp(MCPPermissionClient):
    ...
    async def get_available_tools(self):
        ...
        for tool in mcp_tools:
            ...
            # add parameters and risk level to description
            ...
            # convert MCP inpupt schema to OpenAI paramters
        ...
        try:
            ...
            if isinstance(result, list) and len(result) > 0:
                ...
                if hasattr(content, 'text'):
                    ...
                    if "Permssion required for tool" in result_text and "Please approve this operation" in result_text:
    ...
    def assess_risk(self, tool_name, arguments: dict) -> dict:
        """Assss the risk level of a tool operation"""
